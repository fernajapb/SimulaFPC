...
const plantillasJugadores = {
  ...
  { nombre: "M.Hinestroza", edad: 23, media: 76, posicion: "Delantero" },
...
*/
    ...
    if (nuevoClub === equipoUsuario) {
      ...
      linea = `<li>🔁 ${jugador.nombre} fue transferido de ${jugador.equipoActual} a ${nuevoClub} por $${(precio / 1_000_000).toFixed(1)}M</li>`;
    }
...
if (Math.random() < probabilidadDeVender) {
  ...
  while (ventasRealizadas < maxVentas && jugadoresVendibles.length > 0) {
    ...
    mercadoDiv.innerHTML += `<li>🔻 <b>${jugador.nombre}</b> fue vendido por <b>${equipoUsuario}</b> a <b>${comprador}</b> por $${(precioVenta / 1_000_000).toFixed(2)}M</li>`;
...
function calcularPrecioPorMedia(media) {
  const tabla = [
    { media: 20, precio: 20000 },
    { media: 30, precio: 30000 },
    { media: 40, precio: 40000 },
    { media: 50, precio: 90000 },
    { media: 60, precio: 1300000 },
    { media: 70, precio: 2300000 },
    { media: 75, precio: 5000000 },
